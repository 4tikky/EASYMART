    ...
    <div class="min-h-screen flex items-center justify-center" style="background-color: #f7f6f2;">
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden max-w-6xl w-full m-4">
            <div class="flex flex-col md:flex-row">
                ...
                <!-- Kolom Kanan: Form Pendaftaran (Scrollable) -->
                <div class="w-full md:w-1/2 p-12 max-h-[90vh] overflow-y-auto">
                    <h2 class="text-3xl font-bold text-center mb-8" style="color: #2e603f;">Daftar Akun Penjual</h2>
                    ...
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="space-y-5">
                        ...
                        <!-- Data Akun & PIC  -->
                        <!-- ================== -->
                        <h4 class="text-lg font-semibold text-gray-800 border-b pb-2">Data Akun & PIC</h4>
                        
                        <!-- 3. Nama PIC -->
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-700">Nama PIC (Person in Charge):</label>
                        ...
                        <!-- 4. No Handphone PIC -->
                        <div>
                            <label for="no_handphone_pic" class="block text-sm font-medium text-gray-700">Nomor Handphone PIC:</label>
                        ...
                        <!-- Data Toko        -->
                        <!-- ================== -->
                        <h4 class="text-lg font-semibold text-gray-800 border-b pb-2 pt-4">Data Toko</h4>
                        ...
                        <!-- 2. Deskripsi singkat -->
                        <div>
                            <label for="deskripsi_singkat" class="block text-sm font-medium text-gray-700">Deskripsi Singkat Toko:</label>
                        ...
                        <!-- Alamat PIC & Toko  -->
                        <!-- ================== -->
                        <h4 class="text-lg font-semibold text-gray-800 border-b pb-2 pt-4">Alamat PIC & Toko</h4>

                        <!-- 6. Alamat (nama jalan) PIC -->
                        <div>
                            <label for="alamat_pic" class="block text-sm font-medium text-gray-700">Alamat (Nama Jalan):</label>
                        ...
                        <!-- Data Verifikasi  -->
                        <!-- ================== -->
                        <h4 class="text-lg font-semibold text-gray-800 border-b pb-2 pt-4">Data Verifikasi</h4>

                        <!-- 12. No. KTP PIC -->
                        <div>
                            <label for="no_ktp_pic" class="block text-sm font-medium text-gray-700">No. KTP PIC:</label>
                        ...
                        <!-- 13. Foto PIC -->
                        <div>
                            <label for="foto_pic" class="block text-sm font-medium text-gray-700">Foto PIC (Upload Foto Wajah):</label>
                        ...
                        <!-- 14. File upload KTP PIC -->
                        <div>
                            <label for="file_upload_ktp_pic" class="block text-sm font-medium text-gray-700">File Upload KTP PIC (Upload Foto KTP):</label>
                            <input id="file_upload_ktp_pic" type="file" name="file_upload_ktp_pic" required
                                   class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm cursor-pointer focus:outline-none focus:ring-green-500 focus:border-green-500 text-sm text-gray-900
                                          file:border-0 file:rounded-l-lg
                                          file:bg-gray-70 file:py-3 file:px-5 file:mr-4
                                          file:text-sm file:font-medium file:text-gray-700
                        ...
                        <!-- Keamanan Akun    -->
                        <!-- ================== -->
                        <h4 class="text-lg font-semibold text-gray-800 border-b pb-2 pt-4">Keamanan Akun</h4>
                    ...
                    <div class="text-center mt-6">
                        <p class="text-sm text-gray-600">
                            Sudah Punya Akun? 
                            <a href="{{ route('login') }}" class="font-medium" style="color: #2e603f; hover:underline;">
                                Masuk
                            </a>
                        </p>
                    </div>
